...
void window::Drawsquare(const int iX1, const int iY1, const int ilenght, const drawstyle dsStyle)
{
}
...
void window::DrawregPolygon(const int* iPX, const int* iPY, const int iVertices, const drawstyle dsStyle) {
...
void window::DrawCircle(const int iX, const int iY, const double iRadius, const drawstyle dsStyle) {
